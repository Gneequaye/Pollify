...
export function Notifications() {
  ...
  return (
    <div className="flex flex-col gap-4 md:gap-6">
      ...
      {/* Stats cards — matches Overview/Invitations card style */}
      <div className="grid grid-cols-2 gap-4 @xl/main:grid-cols-4">
        {[
          ...
          { label: 'Alerts',  value: notifications.filter(n => n.type === 'alert').length,   badge: 'Alert',   icon: <IconAlertCircle className="size-3" />,  footer: 'Expired invitations',   sub: 'Needs attention' },
          { label: 'System',  value: notifications.filter(n => n.type === 'system').length,  badge: 'System',  icon: <IconInfoCircle className="size-3" />,   footer: 'Platform events',       sub: 'Automated updates' },
        ].map((c) => (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* Actions inline below message on mobile */}
